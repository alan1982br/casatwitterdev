...
window.addEventListener('message', function(e) {
 ...
 let empresa = localStorage.getItem('@Twitter:empresa');
...
if(e.data !== 'tourLoaded')
  fetch('https://us-central1-casatwitter-815ac.cloudfunctions.net/api/publicevent?displayName='+displayName+'&email='+email+'&empresa='+empresa+'&uid='+uid+'&hotspot_id='+e.data.hotspot_id+'&hotspot_name='+e.data.hotspot_name+'&hotspot_title='+e.data.hotspot_title+'&id_room='+e.data.id_room+'&room_name='+e.data.room_name)
